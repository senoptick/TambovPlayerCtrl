...
# Линии GPIO (gpiod line numbers) для твоих 4 кнопок
# Пример: PA7=7, PA0=0, PA2=2, PA3=3 — подставь свои если другие пины!
BUTTON_LINES = [7, 0, 2, 3]           # кнопка 1,2,3,4

SOUNDS = [
    "1.wav",   # кнопка 1 (линия 7 / PA7)
    "2.wav",   # кнопка 2 (линия 0 / PA0)
    "3.wav",   # кнопка 3 (линия 2 / PA2)
    "4.wav"    # кнопка 4 (линия 3 / PA3)
]
